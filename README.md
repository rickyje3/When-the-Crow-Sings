...
2. Do NOT make any merges if you have conflicts unless you know for sure which changes in the same scene you are ok with overwriting from one branch. Please create pull requests with detailed descriptions of everything changed and wait for them to be reviewed rather than pushing to main directly.
